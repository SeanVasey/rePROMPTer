  ...
  return (
    <div className="relative min-h-[100dvh] bg-[#050505] text-white font-sans selection:bg-[#E63946]/40 overflow-x-hidden pb-20">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-5 sm:px-6">
        {/* Header */}
        <header className="sticky top-0 z-50 pt-5 pb-3 mb-2 -mx-5 px-5 sm:-mx-6 sm:px-6 bg-gradient-to-b from-[#050505]/95 via-[#050505]/70 to-transparent backdrop-blur-xl border-b border-white/[0.02] transition-all duration-300">
